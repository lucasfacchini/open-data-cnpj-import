...
CREATE TABLE IF NOT EXISTS empresa (id char(8), razao_social varchar(150), codigo_natureza_juridica char(4), qualificacao_responsavel char(2), capital_social decimal(20,2), porte tinyint(2), PRIMARY KEY (id));
...
alter table cnae2 disable keys;
alter table empresa2 disable keys;
alter table estabelecimento2 disable keys;
alter table motivo_situacao_cadastral2 disable keys;
alter table municipio2 disable keys;
alter table natureza_juridica2 disable keys;
alter table optante_simples2 disable keys;
alter table pais2 disable keys;
alter table qualificacao_socio2 disable keys;
alter table socio2 disable keys;
